 ...
 * @dev Lettery_AuditReady_v1.3.sol
 *
 * ═══════════════════════════════════════════════════════════════════════════════════════════════
 ...
 * ─────────────────────────────────────────────────────────────────────────────────────────────────
 *
 *   TODAY (V1.3 - Fixed Seed + Yield Materialization):
 ...
 *   - Prize pool Aave yield → Users (proportional share)
 *   - Pot grows via: seed + seed yield + tickets + rollovers + forfeit yield
 *
 *   FUTURE (V2 - Rolling Seed + Saver/Gambler Toggle):
 ...
 * - [DOCS-02] Updated header to clarify V2 saver/gambler toggle (Week 2 appearance)
 *
